...
import "../interfaces/LinkReceiverInterface.sol";

/**
 * @title The Chainlink Operator contract
 * @notice Node operators can deploy this contract to fulfill requests sent to them
 */
contract Operator is AuthorizedReceiver, ConfirmedOwner, LinkReceiver, OperatorInterface {
  ...
  /**
   * @notice Interact with other LinkReceiverInterface contracts by calling onReceiver
  ...
  function ownerTransferAndCall(
    ...
    LinkReceiverInterface receiver = LinkReceiverInterface(to);
    receiver.onReceiver(msg.sender, value, data);
    return true;
  }
